...
class="transition-all grow flex no-underline z-10 grid-cols-[0.75rem_auto_0.75rem] h-12 bg-sky-500
bg-opacity-100 backdrop-blur-sm text-white hover:shadow-lg active:shadow-inner hover:text-black
 justify-center items-center rounded-tr-xl rounded-bl-xl">
	<div class="block z-50 justify-self-start self-start w-3 h-3 border-t border-l border-black opacity-20"></div>
	<div class="transition-all uppercase no-underline grow text-center text-sm flex items-center justify-center">
		{@html iconLink}{text}
	</div>
	<div class="block z-50 justify-self-end self-end w-3 h-3 border-r border-b border-black opacity-20" />
</a>
